...
export function ExperienceCard({ date, title, href = "#", description, tags = [] }: ExperienceCardProps) {
    return (
        <a href={href} className="group/card transition flex flex-col md:flex-row rounded md:hover:bg-orange-800/20 md:p-4 gap-2 md:hover:shadow-lg lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
