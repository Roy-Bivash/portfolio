    ...
    return (
        <header className="lg:h-screen lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24 py-10">
            ...
            <ul className='mt-8 flex items-center gap-5'>
                <li>
                    <a href="https://github.com/Roy-Bivash" target='_blank' className='transition-all block text-textDescription hover:text-slate-200'>
                ...
                <li>
                    <a href="https://www.linkedin.com/in/bivash-roy15" target='_blank' className='transition-all block text-textDescription hover:text-slate-200'>
                ...
                <li>
                    <a href="mailto:bivash.roy.pro@outlook.com" target='_blank' className='transition-all block text-textDescription hover:text-slate-200'>
